...
export default {
  ...
  methods: {
    ...
    upda() {
      axios
        .post("https://saas.jecinfo.com/gateway/black/update", {
          id: this.form.id,
          ip: this.form.ip,
        })
        .then((res) => {
    ...
    handleDelete(index, row) {
      this.$confirm("此操作将永久删除该权限, 是否继续?", "提示", {
        ...
        axios
          .delete("https://saas.jecinfo.com/gateway/black/" + row.id)
          .then((res) => {
            if (res.status === 200) {
              this.getList();
              this.$notify({
    ...
    getList() {
      axios
        .get("https://saas.jecinfo.com/gateway/black/findAll")
        .then((res) => {
          this.list = res.data;
        });
    },
    ...
    submit() {
      axios
        .post("https://saas.jecinfo.com/gateway/black/add", {
          ip: this.form.ip,
        })
        .then((res) => {
          if (res.status === 200) {
